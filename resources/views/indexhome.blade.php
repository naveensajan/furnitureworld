...
<nav class="navbar navbar-primary" style="background-color:#1c1717;">
...
<div class="card-group">
  <div class="card">
    <img height="300" src="images/F114.jpeg" class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title">Sofas</h5>
      <p class="card-text">Rogelio Sofa Cum Bed in Navy Blue Colour.</p>
      <small class="text-muted"><h6>&nbsp;₹ 73,999 </h6> </small>
    </div>
 
    <div class="card-footer">
    <a href="/userlogin" class="btn btn-danger">BUY NOW</a>
    </div>
  </div>
  <div class="card">
    <img  height="300" src="images/tv.jpg" class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title">Cabinetry</h5>
      <p class="card-text">Solid Wood Large TV Console in Provincial Teak Finish</p>
      <small class="text-muted"><h6>&nbsp;₹ 26,999 </h6> </small>
    </div>
  ...
  <div class="card">
    <img height="300" src="images/dini.jpeg" class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title">ALL DINING SETS</h5>
      <p class="card-text">Anitz Solid Wood 6 Seater Dining Set in Teak Finish</p>
      <small class="text-muted"><h6>&nbsp;₹ 27,499</h6> </small>
    </div>
...
<div class="card-group">
  <div class="card">
    <img height="300"src="images/tablec.jpeg" class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title">TABLES</h5>
      <p class="card-text">Zeno Coffee Table in African oak Finish</p>
      <small class="text-muted"><h6>&nbsp;₹ 3,999 </h6> </small>
    </div>
  ...
  <div class="card">
    <img  height="300" src="images/chair.jpeg" class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title">Chair</h5>
      <p class="card-text">Harold Solid Wood Rocking Chair in Honey Oak Finish</p>
      <small class="text-muted"><h6>&nbsp;₹ 16,499 </h6> </small>
    </div>
  ...
  <div class="card">
    <img height="300" src="images/bed.jpeg" class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title">BEDS</h5>
      <p class="card-text">Wood King Size Bed with Storage in Rustic Teak Finish</p>
      <small class="text-muted"><h6>&nbsp;₹ 56,999</h6> </small>
    </div>
...
<div class="card-group">
  <div class="card">
    <img  height="300" src="images/bar.jpeg" class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title">Dining & Bar</h5>
      <p class="card-text">Langley Solid Wood Wine Rack in Olive Grey Finish</p>
      <small class="text-muted"><h6>&nbsp;₹ 29,499 </h6> </small>
    </div>
  ...
  <div class="card">
    <img  height="300" src="images/bean.jpeg" class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title">BEAN BAGS</h5>
      <p class="card-text">Classic XXXL Bean Bag & Liner Round Stool with Beans</p>
      <small class="text-muted"><h6>&nbsp;₹ 3,2999 </h6> </small>
    </div>
  ...
  <div class="card">
    <img height="300" src="images/chaise.jpg" class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title">CHAISE LOUNGERS</h5>
      <p class="card-text">Exclusive Princess LHS Chaise in Dark Purple Colour</p>
      <small class="text-muted"><h6>&nbsp;₹ 25,999</h6> </small>
    </div>
