...
<tr>
    ...
    <td><input type="text"  name="FurnitureCategory" class="form-control" value="{{$proddel->FurnitureCategory}}"></td>
...
<tr>
    <td>Furniture Id</td>
    <td><input type="text"  name="FurnitureId" class="form-control" value="{{$proddel->FurnitureId}}"></td>
</tr>


<tr>
    <td>Furniture Name</td>
    <td><input type="text" name="FurnitureName" class="form-control" value="{{$proddel->FurnitureName}}"></td>
</tr>


<tr>
    <td>Furniture Price</td>
    <td><input type="text" name="FurniturePrice" class="form-control" value="{{$proddel->FurniturePrice}}"></td>
</tr>


<tr>
    <td>Furniture Description</td>
    <td><input type="text" name="FurnitureDescription" class="form-control" value="{{$proddel->FurnitureDescription}}"></td>
</tr>
<tr>
    <td>image</td>
    <td><input type="text" name="pimage" class="form-control" value="{{$proddel->pimage}}"></td>
