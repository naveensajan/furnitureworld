...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form method="post" action="/uesearch" class="d-flex">
      {{ csrf_field() }}
...
<form action="/catdeleteprocess/{{ $catdel->id}}" method="post" enctype="multipart/form-data">
{{csrf_field()}}
...
<tr>
    <td>Category Id</td>
    <td><input type="text"  name="CategoryId" class="form-control" value="{{ $catdel->CategoryId}}"></td>
...
<tr>
    <td>Category Name</td>
    <td><input type="text"  name="CategoryName" class="form-control" value="{{ $catdel->CategoryName}}"></td>
</tr>
<br>
