...
<form action="/orderdeleteprocess/{{$orderdel->id}}" method="post" >
...
<tr>
    <td>Order Id</td>
    <td><input type="text"  name="id" class="form-control" value="{{$orderdel->id}}"></td>
...
<tr>
    <td>Furniture Id</td>
    <td><input type="text"  name="FurnitureId" class="form-control" value="{{$orderdel->FurnitureId}}"></td>
</tr>


<tr>
    <td>User Id</td>
    <td><input type="text" name="userid" class="form-control" value="{{$orderdel->userid}}"></td>
</tr>


<tr>
    <td>Address</td>
    <td><input type="text" name="address" class="form-control" value="{{$orderdel->address}}"></td>
</tr>


<tr>
    <td>Payment Method</td>
    <td><input type="text" name="paymentmethod" class="form-control" value="{{$orderdel->paymentmethod}}"></td>
</tr>
<tr>
    <td>Status</td>
    <td><input type="text" name="status" class="form-control" value="{{$orderdel->status}}"></td>
