      ...
      <div class="row">
        ...
        <div class="col-md-5 intro-section">
          ...
          <h5>Welcome to</h5><h5 class="intro-title" style="color: #da2128;"> Furniture World !</h5>
            ...
            <a href="usersignup" class="btn signup-link-btn">Get an account</a>
          </div>
        </div>
        <div class="col-md-5 form-secion ">
          ...
          <br> <br> <br> <br> 
           ...
           <div class="col-md-2 intro-section">
           <div class="intro-content-wrapper">
           <br> 
           <table><tr>
          
             <td>  <a href="adminlogin" class="btn signup-link-btn">Admin Login</a></td>
           </tr></table>
