...
<br>
 <h4 style="margin-bottom: 30px; font-weight: bold; color: #da2128;"><center>My Cart</center></h4>
 <br>
<div class="container">
<div class="row ">
...
<br>
<img width="200" height="150" src="{{ URL ::asset('assets/project_img/'.$item->pimage) }}">
</div>
<div  class="col col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
<p class="card-text"><small class="text-muted"><h4>{{$item->FurnitureCategory}} </h4></small></p>
